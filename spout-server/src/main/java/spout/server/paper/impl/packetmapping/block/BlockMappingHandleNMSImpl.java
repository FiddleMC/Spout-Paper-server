...
import spout.server.paper.impl.util.mappingpipeline.CrossMappedWithContextMappingFunctionHandleImpl;
import spout.server.paper.impl.util.mappingpipeline.SimpleWithContextMappingFunctionHandleImpl;
