...
/**
 * The implementation of {@link BlockTypeRegistryEntry}.
 */
public abstract class BlockTypeRegistryEntryImpl implements BlockTypeRegistryEntry, SettableKeyAwareRegistryEntryNMS {

    protected @Nullable Identifier key;

    public BlockTypeRegistryEntryImpl(
    ...
    public static final class BuilderImpl extends BlockTypeRegistryEntryImpl implements BlockTypeRegistryEntryBuilderNMS, PaperRegistryBuilder<Block, BlockType> {
