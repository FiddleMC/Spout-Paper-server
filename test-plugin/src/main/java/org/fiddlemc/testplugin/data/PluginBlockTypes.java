...
public final class PluginBlockTypes {
    ...
    public static Supplier<BlockType> DIRT_SLAB = blockType("fiddle_more_shapes:dirt_slab");
    public static Supplier<BlockType> DIRT_STAIRS = blockType("fiddle_more_shapes:dirt_stairs");
